...
CONTRACT_ENTRIES: tuple[ContractEntry, ...] = (
    ...
    ContractEntry(
        name="Modular layer family lifecycle",
        status="validated",
        sources=(
            Path("synaptome/src/visuals/CircuitTraceLayer.cpp"),
            Path("synaptome/src/visuals/AgentFieldLayer.cpp"),
            Path("synaptome/src/visuals/FlockingLayer.cpp"),
            Path("synaptome/bin/data/layers/generative"),
            Path("docs/architecture/layer_migration_workflow.md"),
            Path("tools/validate_modular_layer_families.py"),
        ),
        validator_command="python tools\\validate_modular_layer_families.py",
        fixtures=(Path("synaptome/bin/data/layers/generative"),),
        notes="Locks shared-runtime family identity, stable asset IDs and prefixes, complete defaults, explicit live modes, and deterministic seed/reseed ownership.",
        check_command=(sys.executable, "tools/validate_modular_layer_families.py"),
        public_app=True,
    ),
    ContractEntry(
        name="Cellular Fields lifecycle",
        status="validated",
        sources=(
            Path("synaptome/src/visuals/GameOfLifeLayer.cpp"),
            Path("synaptome/src/visuals/ExcitableMediaLayer.cpp"),
            Path("synaptome/bin/data/layers/generative/game_of_life.json"),
            Path("synaptome/bin/data/layers/generative/excitable_media.json"),
            Path("tools/validate_cellular_fields.py"),
        ),
        validator_command="python tools\\validate_cellular_fields.py",
        fixtures=(
            Path("synaptome/bin/data/layers/generative/game_of_life.json"),
            Path("synaptome/bin/data/layers/generative/excitable_media.json"),
        ),
        notes="Locks distinct cellular runtime identities, stable public IDs and prefixes, canonical defaults with legacy aliases, deterministic owned seed/reseed state, and shared descriptor registration.",
        check_command=(sys.executable, "tools/validate_cellular_fields.py"),
        public_app=True,
    ),
    ContractEntry(
        name="Circuit Lenia presentation",
        status="validated",
        sources=(
            Path("synaptome/src/visuals/LeniaLayer.cpp"),
            Path("synaptome/bin/data/layers/generative/lenia.json"),
            Path("synaptome/bin/data/layers/generative/circuit_lenia.json"),
            Path("tools/validate_circuit_lenia.py"),
        ),
        validator_command="python tools\\validate_circuit_lenia.py",
        fixtures=(
            Path("synaptome/bin/data/layers/generative/lenia.json"),
            Path("synaptome/bin/data/layers/generative/circuit_lenia.json"),
        ),
    ...
    ContractEntry(
        name="Scene and mapping recovery",
        status="validated",
        sources=(
            Path("synaptome/src/ofApp.cpp"),
            Path("synaptome/src/ofApp.h"),
            Path("synaptome/src/io/MidiRouter.cpp"),
            Path("synaptome/src/io/MidiRouter.h"),
            Path("tools/validate_scene_display_transaction.py"),
        ),
        validator_command="python tools\\validate_scene_display_transaction.py",
        fixtures=(
            Path("tools/testdata/runtime_state/layers/scenes/default.json"),
            Path("tools/testdata/runtime_state/layers/scenes/stl-demo.json"),
        ),
        notes="Source-level recovery gate locks staged scene publication, rollback, recoverable JSON writes, transactional MIDI/OSC mapping import, and legacy scenes preserving live mappings when no mapping snapshot is present.",
        check_command=(sys.executable, "tools/validate_scene_display_transaction.py"),
        public_app=True,
    ),
    ContractEntry(
