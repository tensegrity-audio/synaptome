...
Interfering ripples on a damped membrane, rendered as luminous height contours and shaded facets.
...
```sh
g++ -std=c++17 -O2 tests/model_test.cpp -o /tmp/wave_tank_test
/tmp/wave_tank_test
```
