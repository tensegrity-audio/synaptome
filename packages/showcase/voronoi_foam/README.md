...
32 moving periodic Voronoi sites relax toward sampled cell centroids while short-range pressure and shear deform the cells. The rendering reveals breathing cell walls, shifting membranes, and softly filled crystalline tissue.
...
Validate: `python tools/validate_layer_packages.py packages/showcase/voronoi_foam/layer.package.json`. Real renderer acceptance on the show machine remains required.
