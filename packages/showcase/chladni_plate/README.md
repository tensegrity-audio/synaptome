...
Vibrating sand gathers into nodal lace, then scatters and finds new paths as mode orders and forcing change.
...
```sh
g++ -std=c++17 -O2 tests/model_test.cpp -o /tmp/chladni_plate_test
/tmp/chladni_plate_test
```
